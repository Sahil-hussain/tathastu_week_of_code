player1=int(input("enter the run scored by player 1 in 60 balls:"))
player2=int(input("enter the run scored by player 2 in 60 balls:"))
player3=int(input("enter the run scored by player 3 in 60 balls:"))
...
print("Run scored by player 2 if they played 60 more balls is ",player2*2)
print ("Run scored by player 3 if they played 60 more balls is ",player3)
