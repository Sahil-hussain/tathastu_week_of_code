...
def jarvis(data):
    if "how are you" in data:
        ...
        data = data.split(" ")
        location = data[2]
        speak(" hold on sachin ,i will show you where " + location + "is.")
        wb.open_new_tab("https://www.google.n1/maps/place/" + "/&amp;")
    else:
...
x=0
print(" start..")
speak("Hi! sachin, what can I do for you?")
data = recordAudio()
jarvis(data)
